...
/* harmony import */ var fullpage_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! fullpage.js */ "./node_modules/fullpage.js/dist/fullpage.js");
/* harmony import */ var fullpage_js__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(fullpage_js__WEBPACK_IMPORTED_MODULE_5__);
...
document.querySelector('.wrap_arrow-prev').addEventListener('click', function () {
  swiper.slidePrev();
});
document.querySelector('.wrap_arrow-next').addEventListener('click', function () {
  swiper.slideNext();
}); // new fullpage('#fullpage', {
// 	autoScrolling:true,
// 	scrollHorizontally: true,
//   anchors: ['main', 'feature', 'price', 'contacts'],
//   scrollBar: true
// });
...
btn.addEventListener('click', function (e) {
  ...
  getData().then(function (result) {
    ...
    if (result === 'Thank you, we will contact you shortly!') {
      error.style.color = '#63A583';
      name.value = '';
      email.value = '';
      message.value = '';
      setTimeout(function () {
